    ...
    public class LibrariesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Libraries != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Libraries'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Location,Website,Created")] Library library)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Location,Website,Created")] Library library)
        {
            if (id != library.Id)
            {
                return NotFound();
